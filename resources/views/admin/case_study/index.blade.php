            ...
            <div class="box">
                <div class="box-header with-border">
                    <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                            data-url="{{ route('case_study.deleteAll') }}">Delete All Selected
                    </button>
                    <span class="pull-right">
                         <a href="{{ route('case_study.create') }}" class="btn btn-primary">Add</a>
                    </span>
                </div>
                <!-- /.box-header -->
