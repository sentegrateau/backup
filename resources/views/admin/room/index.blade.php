                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach ($rooms as $room)
                            <tr id="tr_{{$room->id}}">
                                ...
                                <td>
                                    <a title="<?php echo (!$room->home_owner) ? 'Activated' : 'Deactivated' ?>"
                                       href="{{route('room.activeDeactivate',['id'=>$room->id,'field_name'=>'home_owner'])}}">
                                        <i class="fa   <?php echo ($room->home_owner) ? 'fa-check active-color' : 'fa-times deActive-color text-red' ?>"
                                           aria-hidden="true"></i>
                                    </a>
                                </td>
                                <td>
                                    <a title="<?php echo (!$room->status) ? 'Activated' : 'Deactivated' ?>"
                                       href="{{route('room.activeDeactivate',['id'=>$room->id,'field_name'=>'status'])}}">
                                ...
                                <td>
                                    ...
                                    <a onclick="return (confirm('Are you sure you want to delete ?'))?true:false"
                                       href="{{route('room.delete',$room->id)}}">
