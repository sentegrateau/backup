            ...
            <div class="box">
                <div class="box-header with-border">
                    {{--  <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                               data-url="{{ route('customers.deleteAll') }}">Delete All Selected
                       </button>--}}

                    <span class="pull-right">
                          <a href="{{ route('customers.index') }}?trash=true" class="btn btn-primary">Trash User</a>
                     </span>
                </div>
                <div class="div-search">
                    @include('admin.customers.customer_search')
                </div>
            </div>
        </div>
        <!-- /.col -->
