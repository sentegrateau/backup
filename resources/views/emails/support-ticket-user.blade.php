         ...
         <tr >
            <td style="
               ...
               Dear {{$ticket->user->name}}
		          ...
		          <tr align="">
            <td align=""  >
                <p style="font-weight:bold; line-height: 22px; color:#74787e;font-size:15px; font-family: 'Roboto', sans-serif; " > Your Ticket Id <b style="color: #f38022;">{{$ticket->ticket_id}} ({{$ticket->title}})</b> has been generated.</p>

				 <p style="  line-height: 25px; font-size:14px;">Thank you for contacting Sentegrate support. Your request has been received and being reviewed by our support team.</p>
