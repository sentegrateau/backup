    ...
    <table style="margin: 15px auto;font-family: 'Roboto', sans-serif;">
        ...
        <tr class=" " style="border-bottom:1px solid #dfdfdf; text-align:left;">
            <td  style="text-align:left;">
                ...
                <img width="170px" src="{{url('public/front/images/pdf-logo.jpg')}}">
        ...
        <tr>
            <td style="
               ...
               display: block;">
                @if($comment->sender_id == Auth::user()->id && $comment->sender_id !=1)
                   Dear {{$comment->supportTicket->user->name}},
                @else
                    Hi Admin,
                @endif
            </td>
        ...
        <tr align="">
            <td align="">
                <p style="font-weight:bold; line-height: 22px; color:#74787e;font-size:15px; font-family: 'Roboto', sans-serif; ">
                    Ticket Id <b style="color: #f38022;">{{$comment->supportTicket->ticket_id}} ({{$comment->supportTicket->title}})</b></p>

                <p style="  line-height: 25px; font-size:14px;"><b>Comment added: </b> {{$comment->message}}</p>
